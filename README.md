...
Dieses Projekt beachtet den [Adobe Open Source Code of Conduct](../code-of-conduct.md) bzw. den [.NET Foundation Code of Conduct](https://dotnetfoundation.org/code-of-conduct). Weitere Informationen finden Sie unter [Beitragen](../contributing.md) Thema.
