...
user-guide-title: Commerce Intelligence-Benutzerhandbuch
...
- Analysieren von Daten {#analyze}
   ...
   - Datenbankintegrationen {#integration}
      ...
      - [Überprüfung des SSH-Hostschlüssels](data-analyst/importing-data/integrations/ssh-host-key-verification.md)
