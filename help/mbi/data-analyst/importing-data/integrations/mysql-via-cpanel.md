...
description: Verbinden einer auf cPanel gehosteten MySQL-Datenbank mit Commerce Intelligence. Erstellen Sie einen dedizierten Benutzer und geben Sie Verbindungsdetails ein, um mit der Synchronisierung Ihrer Daten zu beginnen.
...
>[!NOTE]
>
>Wenn Sie einen SSH-Tunnel verwenden, finden Sie unter [SSH-Hostschlüsselüberprüfung](ssh-host-key-verification.md) Informationen zu Registrierung, Aktualisierung, Fehlermeldungen und Fehlerbehebung.
